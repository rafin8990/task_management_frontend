  ...
  return (
    <section>
      <div className="border-b-2 dark:border-secondaryDark dark:bg-dark py-3 px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8 text-sm dark:bg-dark">
          <FiltersDropdown
            trigger={
              <div className="flex items-center gap-3 opacity-75 hover:opacity-100">
          ...
          <div className="flex items-center gap-3 opacity-75 hover:opacity-100">
            <img className="h-3" src={sortIcon} alt="" />
            <p className="font-semibold">Sort</p>
          </div>
          <button className="">
            <img className="w-4 me-2" src={dotsIcon} alt="" />
          </button>
        </div>
      </div>
    </section>
